...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("nombre", sa.AutoString(), nullable=False),
        sa.Column("descripcion", sa.AutoString(), nullable=True),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_table(
        "tipocuenta",
        sa.Column("id", sa.Integer(), nullable=False),
        sa.Column("tipo", sa.AutoString(), nullable=False),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_table(
        "moneda",
        sa.Column("id", sa.Integer(), nullable=False),
        sa.Column("nombre", sa.AutoString(), nullable=False),
        sa.Column("simbolo", sa.AutoString(), nullable=False),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_table(
        "user",
        ...
        sa.Column("apellido", sa.AutoString(), nullable=False),
        sa.Column("passw", sa.AutoString(), nullable=False),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_table(
        "subtipo",
    ...
    op.create_table(
        "sesion",
        sa.Column("id", sa.Integer(), nullable=False),
        sa.Column("idUser", sa.AutoString(), nullable=False),
        sa.Column("created_at", sa.DateTime(), nullable=False),
        sa.Column("token", sa.AutoString(), nullable=False),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_table(
        "cuenta",
        ...
        sa.Column("user_id", sa.AutoString(), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("user_id", sa.AutoString(), nullable=False),
        sa.Column("cuenta_id", sa.AutoString(), nullable=False),
